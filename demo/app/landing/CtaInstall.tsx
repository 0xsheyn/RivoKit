...
export default function CtaInstall() {
  return (
    <section id="install" className="bg-[var(--ink-raised)] px-5 py-20 md:px-16">
      <div className="mx-auto max-w-2xl text-center">
        ...
        <p className="mx-auto mt-4 max-w-xl text-[15px] leading-relaxed text-[var(--bone)]/75">
          Clone it, run 280 tests with no credentials at all, deploy the escrow to Arc testnet, and clear a full order
          end to end.
        </p>
        ...
        <div className="mt-8 flex flex-wrap items-center justify-center gap-3">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="rounded-sm border border-[color:var(--ash)]/40 px-5 py-2.5 text-sm text-[var(--bone)] hover-step"
          >
            Star on GitHub
          </a>
        </div>
