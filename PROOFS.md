...
Everything under `scripts/` hits real services and needs `.env.local`. Anything
that moves money is gated behind an explicit `CONFIRM=` variable; `probe-*`
scripts fund nothing.
